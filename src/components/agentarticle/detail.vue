<template>
    <div v-show="isLoaded" id="agentArticle">
        <div class="article com-scroll-y">
            ...
            <div class="article-detail" :style="{'min-height': isHasImg || inApp ? 'calc(100% + .02rem)' : 'auto'}">
            ...
            <ul v-if="!inApp && (analyzeInfo.share_list && analyzeInfo.share_list.length > 0) && (moreShare !== 'hide')" class="article-list">
                ...
                <li class="article-block" v-for="(item, index) in analyzeInfo.share_list" :key="index" @click="goArticleDetail(item.uuid, 0)">
            ...
            <div class="box-interval" style="height: .54rem;"></div>
        </div>
