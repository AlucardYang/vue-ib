<template>
    <section id="appCardTemplate" class="card-template-box">
        <div class="card-template">
            <img class="card-light animated fadeInDown slower delay-1s" src="https://static.iberhk.com/v2/web/images/card/christmas/textredsanta/light.png">
            <img class="card-text-christmas animated fadeInDown slower delay-1s" src="https://static.iberhk.com/v2/web/images/card/christmas/textredsanta/christmas.png">
            <img class="card-santa animated fadeInUp slower delay-1s" src="https://static.iberhk.com/v2/web/images/card/christmas/textredsanta/santa.png">
            ...
            <div v-if="showThankBtn" class="card-from animated fast" :class="{'fadeInRight': showThankBtn}" :style="{'top': (cardTextSpanHeight >= $refs.cardTextContent.clientHeight) ? '63%' : ('calc(50% + ' + cardTextSpanHeight / 2 + 'px)')}">
                <div class="from-wish">
...
export default {
    ...
    components: {},
    created() {
        // this.$parent.share.thumbImage = require('https://static.iberhk.com/v2/web/images/card/christmas/textredsanta/shareimg.png');
    },
    mounted() {
...
.card-template-box {
    ...
    background-image: url('https://static.iberhk.com/v2/web/images/card/christmas/textredsanta/bg.png');
}
