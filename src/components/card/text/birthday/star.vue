<template>
    <section id="appCardTemplate" class="card-template-box">
        <div class="card-template">
            <img class="card-text-happy animated fadeInDown slower delay-1s" src="https://static.iberhk.com/v2/web/images/card/birthday/textstar/happy.png">
            <img class="card-star animated fadeInUp slower delay-1s" src="https://static.iberhk.com/v2/web/images/card/birthday/textstar/star.png">
            ...
            <div v-if="showThankBtn" class="card-from animated fast" :class="{'fadeInRight': showThankBtn}" :style="{'top': (cardTextSpanHeight >= $refs.cardTextContent.clientHeight) ? '71%' : ('calc(59% + ' + cardTextSpanHeight / 2 + 'px)')}">
                <div class="from-wish">
...
export default {
    ...
    components: {},
    created() {
        // this.$parent.share.thumbImage = require('https://static.iberhk.com/v2/web/images/card/birthday/textstar/shareimg.png');
    },
    mounted() {
