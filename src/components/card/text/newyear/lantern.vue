<template>
    <section id="appCardTemplate" class="card-template-box">
        <div class="card-template">
            <img class="card-bg animated fadeIn slower delay-1s" src="https://static.iberhk.com/v2/web/images/card/newyear/textlantern/bg.png" :style="{'height': $parent.inIphoneX ? '100%' : 'auto'}">
            <img class="card-text-newyear animated fadeInDown slower delay-2s" src="https://static.iberhk.com/v2/web/images/card/newyear/textlantern/newyear.png">
            <img class="card-lantern animated fadeInUp slower delay-2s" src="https://static.iberhk.com/v2/web/images/card/newyear/textlantern/lantern.png">
            ...
            <div v-if="showThankBtn" class="card-from animated fast" :class="{'fadeInRight': showThankBtn}" :style="{'top': (cardTextSpanHeight >= $refs.cardTextContent.clientHeight) ? '60%' : ('calc(49% + ' + cardTextSpanHeight / 2 + 'px)')}">
                <div class="from-wish">
...
export default {
    ...
    components: {},
    created() {
        // this.$parent.share.thumbImage = require('https://static.iberhk.com/v2/web/images/card/newyear/textlantern/shareimg.png');
    },
    mounted() {
